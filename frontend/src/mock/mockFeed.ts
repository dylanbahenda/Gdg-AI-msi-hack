...
const MOCK_EVENTS: AlertNotification[] = [
  { timestamp: 0, sound_class: "crying",       direction_of_arrival: 45,  distance_estimation: 2.1, sed_confidence: 0.91, priority: "high",   message: "A person appears to be distressed." },
  ...
  { timestamp: 0, sound_class: "dog",          direction_of_arrival: 338, distance_estimation: 1.4, sed_confidence: 0.62, priority: "medium", message: "A dog is present, likely nearby." },
  { timestamp: 0, sound_class: "clap",         direction_of_arrival: 0,   distance_estimation: 1.5, sed_confidence: 0.65, priority: "low",    message: "Someone is clapping." },
];
